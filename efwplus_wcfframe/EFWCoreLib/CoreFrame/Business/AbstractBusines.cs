...
namespace EFWCoreLib.CoreFrame.Business
{
    ...
    public abstract class AbstractBusines : MarshalByRefObject, ICloneable, IbindDb, INewObject, INewDao
    {
        ...
        private Dictionary<string, AbstractDatabase> _oleDbDic = null;
        ...
        public void SetDb(AbstractDatabase database)
        {
            _oleDb = database;
        }

        public void SetUnityContainer(IUnityContainer ucontainer)
        {
