...
namespace EFWCoreLib.UnitTestFrame
{
    public class wcfBaseUnitTest
    {
        ...
        public Object InvokeWcfService(string wcfmethod)
        {
            return InvokeWcfService(wcfmethod, "[]");
        }

        public Object InvokeWcfService(string wcfmethod, string jsondata)
        {
        ...
        public IAsyncResult InvokeWcfServiceAsync(string wcfmethod, string jsondata, Action<Object> action)
        {
            if (string.IsNullOrEmpty(jsondata)) jsondata = "[]";
