...
namespace EFWCoreLib.WebFrame.HttpHandler.Utility
{
    ...
    public class DebugController : WebHttpController
    {
        ...
        public void GetControllerClassNameData()
        {
            ...
            ////把数据输出到页面
            //context.Response.Write(JsonConvert.SerializeObject(getHashList(classlist.ToArray())));
        }
        ...
        public void GetControllerMethodNameData()
        {
            ...
            //context.Response.Charset = "UTF-8";
            ////把数据输出到页面
            //context.Response.Write(JsonConvert.SerializeObject(getHashList(methodlist.ToArray())));
        }
    }
}
